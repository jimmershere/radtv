# R&Dtv — Legal Disclaimer

**Read this before installing or distributing R&Dtv.**

By using, installing, modifying, redistributing, or otherwise interacting
with R&Dtv, you acknowledge that you have read, understood, and accepted
the terms below.
...
R&Dtv is distributed under the **GNU General Public License v3.0** (see
...
R&Dtv is **packaging and configuration software**. It bundles:
...
R&Dtv does **not** host, transmit, mirror, transcode, cache, scrape, or
...
- **What you stream and how you stream it.** The legality of consuming,
  ...
  and your applicable subscription or rights. R&Dtv neither inspects nor
  endorses any specific stream.
- **Which third-party addons you install.** R&Dtv documents third-party
...
- **The terms of any account-based service** you authorize through R&Dtv
...
Public M3U lists (including those referenced or merged by R&Dtv's IPTV
...
**R&Dtv documents the first category by default.** Sources in `iptv/sources.yaml`
that fall in the second category are toggled off by default. The third
category is not included in R&Dtv and is not endorsed.

## 5. No piracy promotion

R&Dtv is built and maintained on the understanding that it will be used for
...
configuring R&Dtv to access copyright-infringing content is not a
sanctioned use** and the authors disclaim any responsibility for users
who choose to do so.

## 6. Anonymization is not a license to infringe

R&Dtv ships scripts and recommendations for VPN, DNS-over-HTTPS, and
...
and copyrights belonging to others that R&Dtv documents, references, or
interoperates with. R&Dtv is **not affiliated with, endorsed by, sponsored
...
If you are a rights holder and believe R&Dtv's documentation or default
configuration references infringing material:

1. Open an issue at <https://github.com/jimmershere/radtv/issues> with
   subject line `DMCA: <title>`, or
2. Email the maintainer listed in the GitHub profile.

Include: the specific work, the specific reference in R&Dtv, your
...
R&Dtv is GPL-3.0. You may modify and redistribute it under the terms of
that license. If you fork or repackage R&Dtv:

- Make it clear that your fork is not the upstream project.
- Don't reuse the "R&Dtv" name or branding for materially different
  software.
